...
int main() {
    std::string input_file_name = "/home/svemula/traceFiles/0.85/workloadc/runKeys.txt";
    std::string output_file_name = "/home/svemula/traceFiles/0.85/workloadc/proxy_benchmark_command_line_input.txt";
