...
int main() {
    std::string input_file_name = "/home/svemula/traceFiles/0.99/workloada/runKeys.txt";
    std::string output_file_name = "/home/svemula/traceFiles/0.99/workloada/proxy_benchmark_command_line_input.txt";
