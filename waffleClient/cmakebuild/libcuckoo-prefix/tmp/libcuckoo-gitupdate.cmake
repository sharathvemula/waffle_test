...
execute_process(
  COMMAND "/usr/bin/git" show-ref 8785773896d74f72b6224e59d37f5f8c3c1e022a
  WORKING_DIRECTORY "/home/avishekde/Desktop/Sharath_Waffle/waffle_final/waffle_test/waffleClient/cmakebuild/libcuckoo-prefix/src/libcuckoo"
...
if("${show_ref_output}" MATCHES "refs/remotes/8785773896d74f72b6224e59d37f5f8c3c1e022a")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "8785773896d74f72b6224e59d37f5f8c3c1e022a")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "8785773896d74f72b6224e59d37f5f8c3c1e022a")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 8785773896d74f72b6224e59d37f5f8c3c1e022a
  WORKING_DIRECTORY "/home/avishekde/Desktop/Sharath_Waffle/waffle_final/waffle_test/waffleClient/cmakebuild/libcuckoo-prefix/src/libcuckoo"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/efficient/libcuckoo.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/avishekde/Desktop/Sharath_Waffle/waffle_final/waffle_test/waffleClient/cmakebuild/libcuckoo-prefix/src/libcuckoo/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/avishekde/Desktop/Sharath_Waffle/waffle_final/waffle_test/waffleClient/cmakebuild/libcuckoo-prefix/src/libcuckoo/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
