...
set(stdout_log "/tmp/waffle_test/waffleClient/cmakebuild/thrift_ep-prefix/src/thrift_ep-stamp/thrift_ep-install-out.log")
set(stderr_log "/tmp/waffle_test/waffleClient/cmakebuild/thrift_ep-prefix/src/thrift_ep-stamp/thrift_ep-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /tmp/waffle_test/waffleClient/cmakebuild/thrift_ep-prefix/src/thrift_ep-stamp/thrift_ep-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "thrift_ep install command succeeded.  See also /tmp/waffle_test/waffleClient/cmakebuild/thrift_ep-prefix/src/thrift_ep-stamp/thrift_ep-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
